...
public class SFFRecipeTypes {
    ...
    public static final DeferredHolder<RecipeType<?>, RecipeType<CarpentryTableRecipe>> CARPENTRY_TABLE_RECIPE = RECIPE_TYPES.register("carpentry_table_recipe", () -> RecipeType.simple(Identifier.fromNamespaceAndPath(FabulousFurniture.MOD_ID, "carpentry_table_recipe")));
